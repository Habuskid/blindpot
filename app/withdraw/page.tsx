...
export default function BlindpotWithdrawFlow() {
  ...
  const handleWithdraw = async () => {
    ...
    setStatusMsg("Executing full principal withdrawal...");

    try {
      await withdraw(VAULT_ADDRESS);
      setStatusMsg("Withdrawal successful! Your principal has been returned to your wallet.");
      setTimeout(() => {
