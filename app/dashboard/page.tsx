...
import { useAccount, useReadContract, useChainId, useSwitchChain, useConnect } from 'wagmi';
...
export default function BlindpotDashboard() {
  ...
  const { data: encryptedWinningsHandle } = useReadContract({
    address: vaultAddress,
    abi: vaultAbi,
