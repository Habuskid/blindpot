...
export default function BlindpotFaucet() {
  ...
  const handleDirectMint = async () => {
    ...
    setErrorMsg(null);
    setTxHash(null);
    setStatusMsg("Submitting on-chain mint on Sepolia testnet (1,000 Test USDC)...");
        ...
        <div className="w-full max-w-[620px] bg-surface border-2 border-primary hard-shadow-lg p-6 md:p-8 flex flex-col relative">
          ...
          <div className="mb-6 border-b-2 border-primary pb-4">
            ...
            <p className="font-body-md text-xs text-on-surface-variant">
              Mint official Zama Sepolia test tokens directly on-chain on <strong>Ethereum Sepolia Testnet</strong> (Chain ID 11155111).
            </p>
          </div>
          ...
          {isWrongNetwork && (
            <div className="bg-error-container border-2 border-error text-error p-4 mb-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs font-mono">
              <div>
                <strong>⚠️ WRONG NETWORK:</strong> Wallet is currently on Chain {chainId} (Mainnet). Please switch to Sepolia (11155111) to avoid mainnet gas.
              </div>
              <button
          ...
          <div className="space-y-4 flex-grow">
            <div className="flex flex-col">
              ...
              <div className="bg-surface-container-low border-2 border-primary p-3 flex items-center justify-between">
                ...
                <span className="material-symbols-outlined text-primary text-[18px] opacity-75">
                  {account ? "verified_user" : "account_balance_wallet"}
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col">
              <label className="font-label-mono text-xs text-on-surface-variant mb-1 uppercase font-bold">
                Verified Sepolia Contracts (from Zama Docs)
              </label>
            ...
            <div className="pt-2 flex flex-col gap-3">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <a
                  href="https://docs.zama.org/protocol/protocol-apps/addresses"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 bg-surface border-2 border-primary py-2.5 px-3 font-label-mono text-xs uppercase text-primary hover:bg-surface-container-high transition-colors text-center flex items-center justify-center gap-1"
                >
                  <span>Official Zama Docs</span>
